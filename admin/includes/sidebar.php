    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
       ...
       <span class="icon-bar"></span>
        ...
        <ul class="nav navbar-right top-nav">
            ...
            <li><a href="index.php?view_product"><i class="fa fa-fw fa-envelope"></i> Products <span class="badge"><?php echo $count_products; ?></span></a></li>
            <li><a href="index.php?view_customers"><i class="fa fa-fw fa-edit"></i> Customer <span class="badge"><?php echo $count_customers; ?></span></a></li>
            <li><a href="index.php?view_p_cat"><i class="fas fa-clone"></i> Product Category<span class="badge"><?php echo $count_p_categories; ?></span>
        </a></li>
            <li><a href="index.php?view_cat"><i class="fas fa-clone"></i> Category<span class="badge"><?php echo $count_categories; ?></span>
        </a></li>
